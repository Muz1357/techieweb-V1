            ...
            <div class="space-y-4">
                ...
                <?php foreach ($customers as $customer): ?>
                    <div class="border-2 border-lblue rounded-lg p-4 mb-4">
                        <h3 class="text-xl font-semibold"><?php echo htmlspecialchars($customer['name']); ?></h3>
                        <p class="text-gray-500">Phone: <?php echo htmlspecialchars($customer['phone']); ?></p>
                        <p class="text-gray-400">Address: <?php echo htmlspecialchars($customer['address']); ?></p>
                    </div>
                <?php endforeach; ?>
